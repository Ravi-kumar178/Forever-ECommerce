        ...
        <div className='bg-white shadow-md rounded-lg px-8 py-6 max-w-md'>
            ...
            <form onSubmit={submitHandler}>
                <div className='mb-3 min-w-72'>
                  ...
                  <input onChange={(e)=>setEmail(e.target.value)} value={email} type="email" placeholder='your@example.com'  className='w-full rounded-md px-3 py-2 border border-gray-300 outline-none' required/>
                </div>
                <div className='mb-3 min-w-72'>
